...
| The idea was to have the ability to take multiple paths, to allow the player to figure out their own prefered way of traversing. In this scenario we have two main paths. <br> <br> Blue (Easy) — This path has you running up some stairs then into a hallway. This path is easy but will take longer than the other one. <br> <br> Red (Hard) — This path is tricky. It requires you to do a few jumps, then pull yourself up from a ledge. By landing into the ledge-pull animation, you're slowed down a bit. But if you manage to make a wall run and jump at a good moment, you're able to avoid the ledge-pull, which in turn makes you even faster. | <img src="/Images/SwiftG4_LD1.png" alt="References" width="2000" height="auto"> |
...
This mentality was used throughout the majority of the Level Design and it lead to quite a fun process for me. The challenging part came during our playtests, I realized that I need to work with clarity. How do I make the intended paths more clear for the player... **Lights!**
